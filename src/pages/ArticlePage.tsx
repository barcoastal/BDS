    ...
    <>
      ...
      <div className="container-wide py-4">
        <nav className="flex items-center gap-1 text-sm text-muted-foreground">
          ...
          <Link to={`/category/${article.category}`} className="hover:text-accent transition-colors">
        ...
        <div className="lg:grid lg:grid-cols-[1fr_240px] lg:gap-12 max-w-5xl mx-auto">
          ...
          <article className="max-w-[720px]">
            <header className="mb-10">
              <span className="category-tag mb-4 inline-block">{getCategoryLabel(article.category)}</span>
            ...
            <nav className="flex justify-between gap-4 mt-12 pt-8 border-t border-border">
              {prev ? (
                <Link to={`/article/${prev.slug}`} className="group flex-1">
              ...
              {next ? (
                <Link to={`/article/${next.slug}`} className="group flex-1 text-right">
